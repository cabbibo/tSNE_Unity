...
public class PressButton : MonoBehaviour {
  ...
  public delegate void SliderDeltaPushed( GameObject t , Vector2 value );
  public event SliderDeltaPushed WhileSliderDeltaPushed;
  ...
  public Vector2 dValueXY;
  public Vector2 oValueXY;
  ...
  void Awake () {
    ...
    dValueXY = new Vector2( 0 , 0);
    oValueXY = new Vector2( 0 , 0);
  ...
  void Update () {
    ...
    if( pressing == true ){
      ...
      if(WhileSliderDeltaPushed != null) WhileSliderDeltaPushed(transform.gameObject, dValueXY );
